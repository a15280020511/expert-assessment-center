...
def _prepare_shadow(
    ...
    _write_catalog_artifacts(root, catalog, resolution, task_digest)
    ...
    _write_shadow_identity(root, proposal, red_team, experts)
    return (
        envelope,
        resolution,
        catalog,
...
def execute_shadow(
    *,
    ...
    return _normalize_and_receipt(output_dir, result, ledger, boundary)
