...
class ExecutionTransportTests(unittest.TestCase):
    def test_batch_is_transport_incompatible_not_a_business_gate(self) -> None:
        ...
        self.assertTrue(classify_model_route("openai/gpt-5.4-nano")["executable"])
    ...
    def test_materialized_plan_never_assigns_sync_incompatible_route(self) -> None:
        ...
        self.assertFalse(receipt["optimizer_audit"]["fixed_metric_role_grammar_used"])
        self.assertFalse(receipt["optimizer_audit"]["metric_role_adapter_used"])
